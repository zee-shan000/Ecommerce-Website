...
function user_register() {
  ...
  if (name == "") {
    alert("#name_error").html("Please enter Name");
    is_error = "yes";
  }
  if (email == "") {
    alert("#email_error").html("Please enter Email");
    is_error = "yes";
  }
  if (mobile == "") {
    alert("#mobile_error").html("Please enter Mobile");
    is_error = "yes";
  }
  if (password == "") {
    alert("#password_error").html("Please enter Password");
    is_error = "yes";
  }
  if (is_error == "") {
    jQuery.ajax({
      ...
      success: function (result) {
        ...
        if (result == "insert") {
          jQuery(".register_msg p").html("Jazak Allah");
        }
      },
    });
  }
...
function user_login() {
  ...
  if (email == "") {
    alert("#login_email_error").html("Please enter Email");
    is_error = "yes";
  }
  if (password == "") {
    alert("#login_password_error").html("Please enter Password");
    is_error = "yes";
  }
  if (is_error == "") {
    jQuery.ajax({
      ...
      success: function (result) {
        if (result == "wrong") {
          jQuery(".login_msg p").html("Enter Correct Details");
        }
        if (result == "valid") {
